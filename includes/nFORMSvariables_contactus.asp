<%
    ...
    dim contactarray:contactarray = Array("General Inquiry - Faith Community Church","Randy Smith - Lead Pastor","Mark Gardner - Associate Pastor")
    dim contactvaluearray()
    for num = 0 to ubound(contactarray)
        redim preserve contactvaluearray(num):contactvaluearray(num) = num
    next
    dim contactemailarray:contactemailarray = Array("faithcommunitychurchonline@gmail.com","faithcommunitychurchonline@gmail.com","MGARD13@aol.com")
